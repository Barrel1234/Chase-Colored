...
int height = 768;
int roadW = 2500;
int segL = 500; //Road different between length
...
int main()
{
	RenderWindow app(VideoMode(width, height), "Start Road Racing!");
	...
	while (app.isOpen())
	{
		...
		for (int n = startPos; n < startPos + 300; n++)
		{
			...
			Color grass = (n / 3) % 2 ? Color(20, 200, 20) : Color(20, 154, 20);
			Color rumble = (n / 3) % 2 ? Color(255, 255, 255) : Color(0, 0, 0);
			Color road = (n / 3) % 2 ? Color(0, 0, 0) : Color(100, 100, 100);
