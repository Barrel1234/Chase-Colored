# Chase-Colored
A simulation game of a 3D Road chase.
...
12.copy and paste the Chase Colored.cpp inside the editor.

13.copy and paste the images folder inside the second folder of the Chase Colored folder.
